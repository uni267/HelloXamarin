...
using HallowXamarinWorld.Services;

using Microsoft.WindowsAzure.MobileServices;
using Xamarin.Forms;

[assembly: Dependency(typeof(HallowXamarinWorld.Droid.Authentication.SocialAuthenticator))]
namespace HallowXamarinWorld.Droid.Authentication
{
